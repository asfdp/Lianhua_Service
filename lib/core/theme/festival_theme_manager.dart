...
class FestivalThemeManager {
  ...
  static ThemeData _getChristmasTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.green, surface: Colors.white),
  ...
  static ThemeData _getQingmingTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.lightGreen[600], surface: Colors.white),
  ...
  static ThemeData _getLaborDayTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.blueGrey[600], surface: Colors.white),
    );
  }
  ...
  static ThemeData _getDragonBoatTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.cyan[600], surface: Colors.white),
  ...
  static ThemeData _getMidAutumnTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.deepOrange[400], surface: Colors.white),
  ...
  static ThemeData _getNationalDayTheme() {
    return ThemeData(
      ...
      ).copyWith(secondary: Colors.yellow[700], surface: Colors.white),
    );
  }
  ...
  static ThemeData _getSpringFestivalTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSwatch(
        primarySwatch: Colors.red,
        backgroundColor: Color(0xFFFFF8DC),
      ).copyWith(secondary: Colors.amber[700], surface: Colors.white),
    );
  }
